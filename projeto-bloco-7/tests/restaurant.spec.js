...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const entry = createMenu({ food: {}, drink: {} });
    assert(Object.keys(entry.fetchMenu)[0] === 'food' &&  Object.keys(entry.fetchMenu)[1] === 'drink');
    ...
    assert.deepStrictEqual(entry.consumption, ['coxinha']);
